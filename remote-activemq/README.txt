...
a persistence unit "remote-activemqPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/org/jboss/as/quickstarts/remote/activemq/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "remote-activemq/pom.xml":
...
artifact ("remote-activemq.war") is already built. You can build
